              ...
              <div className =" flex flex-col gap-[13px] items-center md:gap-[34px] md:my-[58px] md:items-start">
                <Reveals initialX = {-25}>
                  <h1 className ="text-2xl text-center  font-semibold block md:text-[40px] md:text-start md:inline">
                      ...
                      <span className ="block text-[27px]  highlight mt-2 md:text-[45px] md:inline md:mt-0"> Web Developer</span>
                  </h1>
                </Reveals>
                <Reveals initialX = {-30} delay = {0.2}>
                  <p className = "text-center text-sm mx-6 md:text-[22px] md:text-start md:mx-0">I&apos;m very passionate about coding and helping startups create unique and helpful products.</p>
                </Reveals>
                <Reveals initialX = {-40} delay = {0.4}>
                    <a href="mailto:edgarfezeu@gmail.com" className ="self-center bg-primary text-white p-2.5 rounded flex gap-2.5 items-center text-sm md:self-start md:text-xl/6">Let&apos;s Connect {" "}
